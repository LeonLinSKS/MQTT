...
//+km 20210520
#define SKS_GEN_2
#define SK_SECURITY 1
#define HOME_GATEWAY
#define WIFI_SIMPLE_CONFIG
// defined CONFIG_RTL_TRANSMISSION
...
typedef enum
{
	...
	IP_ROUTE = 1,
	IP_PPP = 2
} CMODE_T; // WANIface Mode Not the Method of getting IP address
...
typedef enum
{
	APPTYPE_TR069_INTERNET,
	APPTYPE_INTERNET,
	APPTYPE_TR069,
	APPTYPE_OTHER,
	APPTYPE_VOICE,
	APPTYPE_TR069_VOICE,
	APPTYPE_VOICE_INTERNET,
	APPTYPE_TR069_VOICE_INTERNET
} APPTYPE_T;
typedef enum
{
	PPP_AUTH_AUTO = 0,
...
#define LANDEVNAME2BR0(a)                                                                                   \
	do                                                                                                      \
	{                                                                                                       \
		if (a && (strncmp(a, "eth0", 4) == 0 || strncmp(a, "wlan0", 5) == 0 || strncmp(a, "usb0", 4) == 0)) \
			strcpy(a, "br0");                                                                               \
	} while (0)
...
typedef enum
{
	ETH_DOT1X_CLIENT_MODE = 1,
	ETH_DOT1X_PROXY_MODE = 2
} ETH_DOT1X_MODE_T;
...
enum
{
	CONFIG_BY_INTERNAL_REGISTRAR = 1,
	CONFIG_BY_EXTERNAL_REGISTRAR = 2
};
#endif
typedef enum
{
...
typedef enum
{
	WDS_ENCRYPT_DISABLED = 0,
	WDS_ENCRYPT_WEP64 = 1,
	WDS_ENCRYPT_WEP128 = 2,
	WDS_ENCRYPT_TKIP = 3,
	WDS_ENCRYPT_AES = 4
} WDS_ENCRYPT_T;
typedef enum
...
typedef enum
{
	...
	BRIDGE = 20,
	DHCP_NONE = 99
} DHCP_T; /* # keith: add l2tp support. 20080515 */
typedef enum
{
	DHCP_LAN_NONE = 0,
	DHCP_LAN_CLIENT = 1,
	DHCP_LAN_SERVER = 2,
	DHCP_LAN_RELAY = 3
} DHCP_TYPE_T; // keith add. LAN SIDE DHCP TYPE
typedef enum
{
	GATEWAY_MODE = 0,
	BRIDGE_MODE = 1,
...
typedef enum
{
	VLAN_FORWARD_DISABLED = 0,
	VLAN_FORWARD_BRIDGE = 1,
	VLAN_FORWARD_NAT = 2
} VLAN_FORWARD_TYPE_T;
...
typedef enum
{
	...
	A_MSDU = 2,
	A_MIXED = 3
} AGGREGATION_MODE_T; // GANTOE & epopen: DISABLED=0 original is DISABLE=0, Because conflict with ../../auth/include/1x_common.h in AP/net-snmp-5.x.x
typedef enum
{
	PHYBAND_OFF = 0,
	PHYBAND_2G = 1,
...
typedef enum
{
	...
	TTLS_PHASE2_PAP = 1,
	TTLS_PHASE2_CHAP = 2,
	TTLS_PHASE2_MSCHAP = 3,
	TTLS_PHASE2_MSCHAPV2 = 4
} TTLS_PHASE2_TYPE_T;
typedef enum
{
	TTLS_PHASE2_EAP_MD5 = 0
} TTLS_PHASE2_EAP_METHOD_T;
...
#define FIRMWARE_VER "001.00.546C"
#define FIRMWARE_VER2 "547C" // hanton ver==>032C, agent ver==>515C
