...
// gcc -I ./include LogManage.c -g -o LogManage
// msdk-linux-gcc -I ./include LogManage.c -g -o LogManage
// valgrind --leak-check=full ./LogManage
...
// #ifdef VM
//     ret = system("cp A/sks.log B/sks.log");
//     sprintf(echo_buf, "echo \"%s\" >> B/sks.log &", pArg);
//     system(echo_buf);
//     system("cp B/sks.log A/sks.log");
//     sync();
// #else
//     ret = system("cp /tmp/usb/sda1/log/sks.log /var/www/sks.log");
//     sprintf(echo_buf, "echo \"%s\" >> /var/www/sks.log &", pArg);
//     system(echo_buf);
//     system("cp /var/www/sks.log /tmp/usb/sda1/log/sks.log");
//     sync();
// #endif
